              ...
              <Row style={{ marginTop: "6%", textAlign: "left" }}>
                ...
                <Card bordered={false} hoverable style={{ width: "100%" }}>
                  <Row>
                    ...
                    <Col xl={4} lg={8} md={8} sm={20} xs={20}>
                      <a
                    ...
                    <Col xl={20} lg={16} md={16} sm={24} xs={24}>
                      ...
                      <h3 style={{ float: "right" }}>2023-2024</h3>
                      <Divider />
                      <ul>
                        <li>
                          <h2>
                            Pursuing Masters of Information Systems Management
                          </h2>
                        </li>
                        <li>
                          <h2>
                            Studying courses like Distributed Systems, Java for
                            Application Programmers, Fundamentals of
                            Opertionalizing AI, Data Structures and Algorithms
                  ...
                  <Row>
                    ...
                    <Col xl={20} lg={16} md={16} sm={24} xs={24}>
                      <h2 style={{ float: "left" }}>
                        <b>Pune Insitute of Computer Technology</b>
                      </h2>
                      <h3 style={{ float: "right" }}>2019-2023</h3>
                      <Divider />
                      <ul>
                        <li>
                          <h2>
                            Pursued Bachelors of Engineering in Information
                            Technology
                          </h2>
                        </li>
                        <li>
                          <h2>
                            Studied computer science subjects like Distributed
                            Systems, Web Application Development, Design and
                            Analysis of Algorithms, Data Structures, Algorithms,
                            Database Management Systems, Information Retrival
                            Systems etc.
                          </h2>
                        </li>
                      </ul>
