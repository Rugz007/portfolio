                    ...
                    <Col lg={16} md={20} sm={18} xs={18}>
                        <Fade>
                            <Row style={{ textAlign: 'left', marginTop: "5%" }}>
                                ...
                                <h3 style={{ color: 'black' }}>I am a final year IT student at Pune Institute of Computer Technology, currently working in the fields of Website Development and Data Science.
