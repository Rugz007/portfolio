                ...
                <Card bordered={false} hoverable style={{ width: "100%" }}>
                  <Row>
                    ...
                    <Col xl={19} lg={16} md={16} sm={24} xs={24}>
                      <h2 style={{ float: "left" }}>
                        <b>Front-end Developer Intern</b>
                      </h2>
                  ...
                  <Row style={{ marginBottom: "1%" }}>
                    ...
                    <Col xl={19} lg={16} md={16} sm={24} xs={24}>
                      <h2 style={{ float: "left" }}>
                        <b>Website Development Intern</b>
                      </h2>
                  ...
                  <Row style={{ marginBottom: "1%" }}>
                    ...
                    <Col xl={19} lg={16} md={16} sm={24} xs={24}>
                      <h2 style={{ float: "left" }}>
                        <b>Full Stack Development Intern</b>
                      </h2>
                      <h3 style={{ float: "right" }}>April 2021 - Present</h3>
                      <Divider />
                      <h2>
                        Technologies Used:
                        <img
                      ...
                      <ul>
                        <li>
                          <h2>
                            Developing an online circuit and Arduino simulator.
                          </h2>
                        </li>
                      </ul>
                      <a
